...
```
helm upgrade --install my-n8n oci://8gears.container-registry.com/library/n8n --version 1.0.14 --set main.service.type=NodePort,main.config.n8n.hide_usage_page=true,main.service.port=5678
